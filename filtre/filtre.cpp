...
// filtre.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CfiltreApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CfiltreApp

CfiltreApp::CfiltreApp()
{
...
// Seul et unique objet CfiltreApp

CfiltreApp theApp;


// initialisation de CfiltreApp

BOOL CfiltreApp::InitInstance()
{
